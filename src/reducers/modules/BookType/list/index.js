...
export const getBookTypes = (pagination = false) => {
  return (dispatch) => {
    ...
    return axios
      .get(
        `${process.env.REACT_APP_BACKEND_SOURCE}/bookTypes${
...
export const getBookType = (id) => {
  return (dispatch) => {
    ...
    return axios
      .get(`${process.env.REACT_APP_BACKEND_SOURCE}/bookTypes/${id}`)
      .then(({data}) => {
        dispatch({ type: SET_BOOKTYPES_LIST_ITEMS, payload: data });
        dispatch({ type: SET_BOOKTYPES_LIST_IS_LOADING, payload: false });
        dispatch({ type: SET_BOOKTYPES_LIST_META, payload: [] });
...
export const getBookTypeFiltre =(params)=>{
  return (dispatch) => {
    ...
    return axios
      .get(
        `${process.env.REACT_APP_BACKEND_SOURCE}/bookTypes?pagination=false`
      )
      .then(({data}) => {
