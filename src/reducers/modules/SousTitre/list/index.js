...
export const getSousTitres = (pagination = false) => {
  return (dispatch) => {
    ...
    return axios
      .get(
        `${process.env.REACT_APP_API_URL}/sous_titres${
...
export const getCourSousTitres = (id) => {
  return (dispatch) => {
    ...
    return axios
      .get(
        `${process.env.REACT_APP_API_URL}/sous_titres?courId=${id}&${relationSousTitres}`
      )
      .then(({data}) => {
        dispatch({ type: SET_SOUSTITRES_LIST_ITEMS, payload: data });
        dispatch({ type: SET_SOUSTITRES_LIST_IS_LOADING, payload: false });
...
export const getSousTitre = (id) => {
  return (dispatch) => {
    ...
    return axios
      .get(`${process.env.REACT_APP_API_URL}/sous_titres/${id}`)
      .then(({data}) => {
        dispatch({ type: SET_SOUSTITRES_LIST_ITEMS, payload: data });
        dispatch({ type: SET_SOUSTITRES_LIST_IS_LOADING, payload: false });
        dispatch({ type: SET_SOUSTITRES_LIST_META, payload: [] });
...
export const getSousTitreFiltre =(params)=>{
  return (dispatch) => {
    ...
    return axios
      .get(
        `${process.env.REACT_APP_API_URL}/sous_titres?pagination=false`
      )
      .then(({data}) => {
