...
import {
  updateCour
} from "../../../../reducers/modules/Cour/update";
...
const UpdateCourAdmin = () => {
 ...
 useEffect(() => {
  ...
  const handleSubmit = async (e)=>{
    ...
    await dispatch(updateCour(itemsForm));
    navigate("/admin/cours/"+itemsForm.id)
  }
  ...
  return (
    <>
      <LayoutAdmin actif="cours">
        ...
        <Tooltip anchorSelect=".my-tooltip" /></>):(<>isLoading</>)}
      </LayoutAdmin>
    </>
  );
};

export default UpdateCourAdmin;
