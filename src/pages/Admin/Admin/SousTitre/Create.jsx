...
import { createSousTitre } from "../../../../reducers/modules/SousTitre/create";
...
//   const [sousTitreForm, setSousTitreForm] = useState({});
  ...
  const handleSubmit = async (e) => {
    ...
    await dispatch(createSousTitre(itemsForm));
    navigate("/admin/cours/" + id + "/sous_titres");
  };
  const [sousTitreForm, setSousTitreForm] = useState({isUser:true,qcm:[{id:1,question:"",explication:"",propositions:[{id:1,reponse:"",isgood:true},{id:2,reponse:"",isgood:false},{id:3,reponse:"",isgood:false},{id:4,reponse:"",isgood:false}]}],isQcm:false,})
...
export default CreateSousTitreAdmin;
