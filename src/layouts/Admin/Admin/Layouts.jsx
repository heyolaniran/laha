...
const LayoutAdmin = ({children,actif = "tb",}) => {
  const {user,isAuth} = useSelector(state=> state.auth);
  const dispatch = useDispatch();
  const navigate = useNavigate();
  useEffect(() => {
     if(user && (user.role == "admin" || user.role == "prof")){
        console.log('user is admin or prof')
     }else{
        localStorage.clear();
        navigate('/login')
     }
      ...
      <div className="layout-container">
        ...
        >
          <div className="app-brand demo">
            <Link to="/admin/dashboard" href="index.html" className="app-brand-link">
              <span className="app-brand-logo demo">
                <img src="/template/etrain-master/img/favicon.png" width="50px" alt="" />
              </span>
              <span className=" demo fw-bolder ms-2" style={{color:"#32CD32"}}>
                GESCO <span style={{fontSize:"10px",fontWeight:"bold"}}>Admin</span>
              </span>
            </Link>
          ...
          <ul className="menu-inner py-1 mt-0" style={{paddingBottom:"20px"}}>
            ...
            <li className={actif === "cours" ? "menu-item active":'menu-item'}>
              <Link to="/admin/cours"  className="menu-link ">
            ...
            <li className={actif === "rept" ? "menu-item active":'menu-item'}>
              <Link to="/admin/repetitions" href="j" className="menu-link ">
            ...
            <li className={actif === "livres" ? "menu-item active":'menu-item'}>
              <Link to="/admin/livres" href="j" className="menu-link ">
            ...
            <li className={actif === "qr" ? "menu-item active":'menu-item'}>
              <Link to="/admin/question-reponse"  className="menu-link">
            ...
            <li className={actif === "forum" ? "menu-item active":'menu-item'} onClick={(e)=>{
              ...
              <ul className="menu-sub">
                <li className="menu-item">
                  <Link to={"/admin/forums/national"}  className="menu-link">
                    <div data-i18n="Error">National</div>
                  </Link>
                </li>
                <li className="menu-item">
                  <Link to={"/admin/forums/international"}  className="menu-link">
            ...
            <li className={actif === "abon" ? "menu-item active":'menu-item'}>
              <Link to="/admin/mon_abonnement" href="cards-basic.html" className="menu-link">
                <i className="menu-icon tf-icons bx bx-crown"></i>
                <div data-i18n="Basic">Professeurs</div>
              </Link>
            </li>
            <li className="menu-header small text-uppercase">
