      ...
      <div className="col-lg-3">
        <div className="card">
          <div className="card-body">
            ...
            <h6 className="card-price text-center">75.000F<span className="period">/an</span></h6>
            <hr />
            <ul className="fa-ul">
                <li><span className="fa-li"><i className="fas fa-check"></i></span>Accès aux <b>Cours</b></li>
                <li><span className="fa-li"><i className="fas fa-check"></i></span>Accès aux <b>Exercices</b></li>
      ...
      <div className="col-lg-3">
        <div className="card">
          <div className="card-body">
            ...
            <h6 className="card-price text-center">100.000F<span className="period">/an</span></h6>
            <hr />
            <ul className="fa-ul">
                <li><span className="fa-li"><i className="fas fa-check"></i></span>Accès aux <b>Cours</b></li>
                <li><span className="fa-li"><i className="fas fa-check"></i></span>Accès aux <b>Exercices</b></li>
